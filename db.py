...
class DataBase:
    ...
    def insert_page(self, data_object):
        cur = self.conn.cursor()
        cur.execute("INSERT INTO crawldb.page VALUES (%s, %s, %s, %s, %s, %s)",
    ...
    def insert_image(self, data_object):
        cur = self.conn.cursor()
        cur.execute("INSERT INTO crawldb.image VALUES (%s, %s, %s, %s, %s)",
    ...
    def insert_page_data(self, data_object):
        cur = self.conn.cursor()
        cur.execute("INSERT INTO crawldb.page_data VALUES (%s, %s, %s)",
